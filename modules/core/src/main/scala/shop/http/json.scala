...
private[http] trait JsonCodecs {
  ...
  implicit val categoryPramDecoder: Decoder[CategoryParam] =
  ...
  implicit val cartEncoder: Encoder[Cart] = // Requires the coercibleKeyEncoder
    Encoder.forProduct1("items")(_.items)

  implicit val cartDecoder: Decoder[Cart] = // Requires the coercibleKeyDecoder
